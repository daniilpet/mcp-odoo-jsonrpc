...
def test_translate_task_with_parent():
    task = translate_task(_make_record(parent_id={"id": 50, "display_name": "Epic"}))
...
def test_translate_task_date_with_time():
    task = translate_task(_make_record(date_deadline="2026-02-16 14:00:00"))
    assert task.deadline is not None
    assert str(task.deadline) == "2026-02-16"


def test_translate_task_duration_tracking():
    task = translate_task(_make_record(duration_tracking={"902": 261659, "903": 196593}))
